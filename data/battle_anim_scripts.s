...
gBattleAnims_Moves::
	...
	.4byte Move_FINAL_STING
	.4byte Move_FREEZE_RAY
	.4byte Move_VILE_CUTTER
	.4byte Move_FIRE_CRASH
	.4byte Move_THUNDER_CRASH
	.4byte Move_STAGGER
	.4byte Move_TOMBSTONER
	.4byte Move_SPROUT
	.4byte Move_SHRED
	.4byte Move_ENTWINE
	.4byte Move_DRAGON_FIST
	.4byte Move_SOUL_STEAL
	.4byte Move_ICE_SLASHER
	.4byte Move_SPIRIT_PURGE
	.4byte Move_U_TURN
	.4byte Move_CHISEL
	.4byte Move_ASCENSION
	.4byte Move_AWAKENING
	.4byte Move_ATTUNEMENT
	.4byte Move_VENOM_FANG
	.4byte Move_GEYSER
	.4byte Move_FLYING_KNEE
	.4byte Move_BULLET_PUNCH
	.4byte Move_CLOSE_COMBAT
	.4byte Move_DRAGON_LASH
	.4byte Move_REVOLVER
	.4byte Move_FLY_SWAT
...
Move_YOGA_LOOP:
	...
	createvisualtask AnimTask_ThrashMoveMonHorizontal, 1
	createvisualtask AnimTask_AttackerPunchWithTrace, 2, RGB(16, 28, 31), 14
	createsprite gFistFootRandomPosSpriteTemplate, ANIM_TARGET, 3, 1, 10, 0
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_TARGET, 4, 0, 7, 1
	playsewithpan SE_M_COMET_PUNCH, SOUND_PAN_TARGET
	delay 3
	...
	delay 9
	createsprite gMegaPunchKickSpriteTemplate, ANIM_ATTACKER, 3, 0, 0, 0, 16
	delay 13
	createvisualtask AnimTask_AttackerPunchWithTrace, 2, RGB(16, 28, 31), 14
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_TARGET, 4, 0, 5, 1
	...
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 1, -16, 16, 1, 1
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 1, 16, 16, 1, 1
	delay 1
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 1, 0, 0, 1, 1
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 1, -24, -12, 1, 1
	delay 1
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 1, 24, -24, 1, 1
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_TARGET, 4, 0, 5, 1
	playsewithpan SE_M_HORN_ATTACK, SOUND_PAN_TARGET
	delay 3
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_TARGET, 4, 0, 5, 1
...
Move_SCISSOR_KICK::
	choosetwoturnanim ScissorKick, ScissorKickEX
ScissorKickEX:
	loadspritegfx ANIM_TAG_LIGHTNING
	loadspritegfx ANIM_TAG_EXPLOSION
	loadspritegfx ANIM_TAG_EXPLOSION_6
	...
	playsewithpan SE_M_DOUBLE_TEAM, SOUND_PAN_ATTACKER
	delay 6
	createsprite gStompFootSpriteTemplate, ANIM_ATTACKER, 0, 0, -42, 0
	delay 3
	createsprite gComplexPaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG | F_PAL_BATTLERS, 3, 1, RGB(9, 8, 10), 4, RGB_BLACK, 0
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 12, 0, 2, ANIM_TARGET, 2
	createvisualtask AnimTask_ShakeMon, 2, ANIM_TARGET, 0, 4, 9, 1
	playsewithpan SE_M_VITAL_THROW2, SOUND_PAN_TARGET
	createvisualtask AnimTask_InvertScreenColor, 2, 257, 257, 257
	createsprite gLightningSpriteTemplate, ANIM_TARGET, 2, 0, -60
	createvisualtask AnimTask_ScaleMonAndRestore, 5, -5, -5, 10, ANIM_TARGET, 1
	playsewithpan SE_M_TRI_ATTACK2, SOUND_PAN_TARGET
	delay 1
	createsprite gLightningSpriteTemplate, ANIM_TARGET, 2, 0, -46
	delay 1
	createvisualtask AnimTask_InvertScreenColor, 2, 257, 257, 257
	createsprite gLightningSpriteTemplate, ANIM_TARGET, 2, 0, -26
	delay 1
	createsprite gLightningSpriteTemplate, ANIM_TARGET, 2, 0, 6
	playsewithpan SE_M_MEGA_KICK2, SOUND_PAN_TARGET
	createvisualtask AnimTask_HorizontalShake, 5, ANIM_TARGET, 5, 10
	delay 12
	createvisualtask AnimTask_TraceMonBlended, 2, 0, 4, 7, 3
	createvisualtask AnimTask_AttackerPunchWithTrace, 2, RGB(8, 9, 28), 10
	createsprite gSlidingKickSpriteTemplate, ANIM_ATTACKER, -12, -12, 0, 48, 10, 160, 0
	playsewithpan SE_M_RAZOR_WIND2, SOUND_PAN_ATTACKER
	delay 5
	createsprite gComplexPaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG | F_PAL_BATTLERS, 3, 1, RGB(9, 8, 10), 4, RGB_BLACK, 0
	createsprite gCrossImpactSpriteTemplate, ANIM_ATTACKER, 3, 0, 0, 1, 10
	createvisualtask AnimTask_ShakeMon, 2, ANIM_TARGET, 5, 0, 9, 1
	createsprite gComplexPaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG | F_PAL_BATTLERS, 3, 1, RGB(9, 8, 10), 4, RGB_BLACK, 0
	playsewithpan SE_M_HEADBUTT, SOUND_PAN_TARGET
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 1, -16, 16, 1, 1
	createsprite gExplosionSpriteTemplate, ANIM_ATTACKER, 1, 16, 16, 1, 1
...
Move_SOUL_STEAL:
	...
	delay 6
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 0, 15, 0, RGB_BLACK
	...
	delay 4
	createsprite gReversalOrbSpriteTemplate, ANIM_TARGET, 2, 26, 0
	createsprite gReversalOrbSpriteTemplate, ANIM_TARGET, 2, 26, 42
	createsprite gReversalOrbSpriteTemplate, ANIM_TARGET, 2, 26, 84
	createsprite gReversalOrbSpriteTemplate, ANIM_TARGET, 2, 26, 126
	createsprite gReversalOrbSpriteTemplate, ANIM_TARGET, 2, 26, 168
	createsprite gReversalOrbSpriteTemplate, ANIM_TARGET, 2, 26, 210
	playsewithpan SE_M_SWAGGER, SOUND_PAN_TARGET
...
CrunchEX:
	...
	setalpha 12, 8
	playsewithpan SE_M_BITE, SOUND_PAN_TARGET
	createsprite gHorizontalLungeSpriteTemplate, ANIM_ATTACKER, 2, 3, 6
	createsprite gSharpTeethSpriteTemplate, ANIM_ATTACKER, 2, -32, -32, 1, 819, 819, 10
	createsprite gSharpTeethSpriteTemplate, ANIM_ATTACKER, 2, 32, 32, 5, -819, -819, 10
	delay 10
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 2, -8, 0, ANIM_TARGET, 1
...
Move_TRI_ATTACK:
	...
	playsewithpan SE_M_TRI_ATTACK, SOUND_PAN_ATTACKER
	delay 20
	createsoundtask SoundTask_LoopSEAdjustPanning, SE_M_TRI_ATTACK, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, 5, 4, 0, 7
	delay 12
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 2, 0, 16, RGB_BLACK
	delay 16
	loadspritegfx ANIM_TAG_FIRE
...
EXMove:
	createvisualtask AnimTask_ScaleMonAndRestore, 5, -5, -5, 10, ANIM_ATTACKER, 1
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 0, 0, 16, RGB_YELLOW
	playsewithpan SE_SHINY, SOUND_PAN_ATTACKER
	delay 4
	waitforvisualfinish
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 0, 15, 0, RGB_YELLOW
	delay 4
	return
...
SoulStealFlash:
	createvisualtask AnimTask_ScaleMonAndRestore, 5, -5, -5, 10, ANIM_ATTACKER, 1
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 0, 0, 16, RGB_WHITEALPHA
	playsewithpan SE_M_LEER, SOUND_PAN_ATTACKER
	delay 4
	waitforvisualfinish
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 0, 15, 0, RGB_WHITEALPHA
	delay 4
	return
...
Move_VILE_CUTTER:
	...
	monbg ANIM_TARGET
	setalpha 12, 8
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 2, 0, 9, RGB_BLACK
	fadetobgfromset BG_GUILLOTINE_OPPONENT, BG_GUILLOTINE_PLAYER, BG_GUILLOTINE_CONTESTS
	waitbgfadein
	createvisualtask AnimTask_AttackerPunchWithTrace, 2, RGB(24, 6, 23), 10
	playsewithpan SE_M_RAZOR_WIND2, SOUND_PAN_ATTACKER
	delay 3
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 2, 9, 0, RGB_BLACK
	createsprite gSlashSliceSpriteTemplate, ANIM_TARGET, 24, 12, 12, -16
	createvisualtask AnimTask_ShakeMon, 2, ANIM_TARGET, 3, 0, 6, 1
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	delay 2
	createsprite gSlashSliceSpriteTemplate, ANIM_TARGET, 2, 1, -4, 0
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	delay 2
	createsprite gSlashSliceSpriteTemplate, ANIM_TARGET, -24, -12, -20, 16
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	delay 8
	call PoisonBubblesEffect
	waitforvisualfinish
...
Move_FIRE_CRASH:
	loadspritegfx ANIM_TAG_SMALL_EMBER
	playsewithpan SE_M_FLAME_WHEEL, SOUND_PAN_ATTACKER
	waitplaysewithpan SE_M_FLAME_WHEEL, SOUND_PAN_ATTACKER, 8
	waitplaysewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_ATTACKER, 8
	setalpha 12, 8
...
Move_THUNDER_CRASH:
	...
	loadspritegfx ANIM_TAG_SPARK_2
	playsewithpan SE_M_CHARGE, SOUND_PAN_ATTACKER
	waitplaysewithpan SE_M_CHARGE, SOUND_PAN_ATTACKER, 8
	waitplaysewithpan SE_M_CHARGE, SOUND_PAN_ATTACKER, 8
	monbg ANIM_ATTACKER
	setalpha 12, 8
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 2, 0, 9, RGB_YELLOW
	createsprite gElectricPuffSpriteTemplate, ANIM_ATTACKER, 2, 0, 16, 16
	delay 2
	waitplaysewithpan SE_M_CHARGE, SOUND_PAN_ATTACKER, 8
	createsprite gElectricPuffSpriteTemplate, ANIM_ATTACKER, 2, 0, -16, -16
	delay 2
	createsprite gElectricPuffSpriteTemplate, ANIM_ATTACKER, -2, 0, 8, 8
	delay 2
	createsprite gElectricPuffSpriteTemplate, ANIM_ATTACKER, -2, 0, -8, -8
	waitforvisualfinish
	delay 10
	...
	createvisualtask AnimTask_InvertScreenColor, 2, 257, 257, 257
	createsprite gSlideMonToOffsetSpriteTemplate, ANIM_ATTACKER, 2, 1, -32, 0, 0, 3
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 0, 16, 16, RGB_BLACK
	createsprite gLightningSpriteTemplate, ANIM_TARGET, 2, 0, -48
	delay 1
	createsprite gLightningSpriteTemplate, ANIM_ATTACKER, 2, 0, -16
	delay 1
	...
	createvisualtask AnimTask_RotateMonSpriteToSide, 2, 8, -256, ANIM_ATTACKER, 1
	createvisualtask AnimTask_RotateMonSpriteToSide, 2, 8, -256, ANIM_TARGET, 1
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 2, 9, 0, RGB_YELLOW
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 2, 16, 0, RGB_BLACK
	waitforvisualfinish
	createsprite gSlideMonToOriginalPosSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, 5
	delay 3
...
Move_STAGGER:
	...
	delay 10
	playsewithpan SE_M_ATTRACT, SOUND_PAN_TARGET
	createsprite gDizzyPunchDuckSpriteTemplate, ANIM_TARGET, 3, 0, -8, 160, -32
	createsprite gDizzyPunchDuckSpriteTemplate, ANIM_TARGET, 3, 0, -8, -256, -40
	createsprite gDizzyPunchDuckSpriteTemplate, ANIM_TARGET, 3, 0, -8, 128, -16
	createsprite gDizzyPunchDuckSpriteTemplate, ANIM_TARGET, 3, 0, -8, 416, -38
	createsprite gDizzyPunchDuckSpriteTemplate, ANIM_TARGET, 3, 0, -8, -128, -22
	createsprite gDizzyPunchDuckSpriteTemplate, ANIM_TARGET, 3, 0, -8, -384, -31
	createvisualtask AnimTask_ShakeMon2, 4, ANIM_TARGET, 4, 0, 5, 1
	createvisualtask AnimTask_StretchTargetUp, 3
	waitforvisualfinish
	end
...
Move_TOMBSTONER:
	...
	createvisualtask AnimTask_ShakeBattlePlatforms, 2, 2, 0, 10, 1
	waitforvisualfinish
	createsprite gRockTombRockSpriteTemplate, ANIM_TARGET, 2, 20, 12, 64, 90, 0
	createsprite gRockTombRockSpriteTemplate, ANIM_TARGET, 2, -20, 12, 64, 90, 0
	delay 8
	createvisualtask AnimTask_ShakeBattlePlatforms, 2, 0, 2, 3, 1
	playsewithpan SE_M_STRENGTH, SOUND_PAN_TARGET
	...
	createsprite gRockTombRockSpriteTemplate, ANIM_TARGET, 2, -3, 13, 64, 66, 0
	delay 4
	createsprite gRockTombRockSpriteTemplate, ANIM_TARGET, 66, 3, 6, 64, 66, 0
	delay 8
	createvisualtask AnimTask_ShakeBattlePlatforms, 2, 0, 2, 3, 1
	playsewithpan SE_M_STRENGTH, SOUND_PAN_TARGET
	delay 8
	createsprite gRockTombRockSpriteTemplate, ANIM_TARGET, 2, 0, 2, 64, 55, 0
	delay 12
	playsewithpan SE_M_ROCK_THROW, SOUND_PAN_TARGET
	waitplaysewithpan SE_M_TRI_ATTACK2, SOUND_PAN_TARGET, 8
	createvisualtask AnimTask_SetGrayscaleOrOriginalPal, 5, ANIM_TARGET, FALSE
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 0, 16, 16, RGB_WHITE
	createsprite gRockFragmentSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, 20, 24, 14, 2
	createsprite gRockFragmentSpriteTemplate, ANIM_ATTACKER, 2, 5, 0, -20, 24, 14, 1
	...
	createsprite gRockFragmentSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, -30, 18, 8, 2
	createsprite gRockFragmentSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, -30, -18, 8, 2
	createsprite gRedXSpriteTemplate, ANIM_TARGET, 5, ANIM_TARGET, 65
	createvisualtask AnimTask_ShakeMon, 5, ANIM_TARGET, 3, 0, 20, 1
	createvisualtask AnimTask_ShakeBattlePlatforms, 2, 2, 0, 10, 1
	waitforvisualfinish
	delay 12
...
Move_SPROUT:
	...
	splitbgprio_foes ANIM_TARGET
	setalpha 12, 8
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 16, -3, 0, 0, 80
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 16, -18, 0, 3, 75
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 1, 0, 4, RGB(13, 31, 12)
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 16, -6, 0, 2, 70
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 16, -12, 0, 2, 70
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 2, -10, -10, ANIM_TARGET, 3
	createsprite gAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 3, 10, -5, -8, 26
...
Status_Sprout:
	...
	splitbgprio_foes ANIM_TARGET
	setalpha 12, 8
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 75, 0, -3, 0, 0, 50
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 75, 0, -18, 0, 3, 45
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 75, 0, -6, 0, 2, 40
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 75, 0, -12, 0, 2, 40
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 2, -10, -10, ANIM_TARGET, 3
	playsewithpan SE_M_DOUBLE_SLAP, SOUND_PAN_TARGET
...
Move_SHRED:
	loadspritegfx ANIM_TAG_SCRATCH
	setalpha 12, 8
	createsprite gScratchSpriteTemplate, ANIM_ATTACKER, 2, -10, -10, ANIM_TARGET, 3
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_TARGET, 3, 0, 6, 1
	createvisualtask AnimTask_TranslateMonEllipticalRespectSide, 2, ANIM_ATTACKER, 24, 6, 1, 5
	delay 3
	createsprite gScratchSpriteTemplate, ANIM_ATTACKER, 2, 10, 8, ANIM_TARGET, 3
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_TARGET, -4, 1, 12, 1
	delay 3
	createsprite gScratchSpriteTemplate, ANIM_ATTACKER, 2, 10, -3, ANIM_TARGET, 2
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_TARGET, 3, 0, 6, 1
	delay 3
	createsprite gScratchSpriteTemplate, ANIM_ATTACKER, 2, -3, 1, ANIM_TARGET, 2
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_TARGET, -4, 1, 12, 1
	delay 2
	createsprite gScratchSpriteTemplate, ANIM_ATTACKER, 2, -10, 1, ANIM_TARGET, 1
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_TARGET, 3, 0, 6, 1
	delay 2
	createsprite gScratchSpriteTemplate, ANIM_ATTACKER, 2, 0, 10, ANIM_TARGET, 1
	playsewithpan SE_M_RAZOR_WIND, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_TARGET, -4, 1, 12, 1
	waitforvisualfinish
	end
...
Move_ENTWINE:
	...
	loadspritegfx ANIM_TAG_IMPACT
	setalpha 12, 8
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 10, 3, 0, 0, 80
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createvisualtask AnimTask_ScaleMonAndRestore, 5, 10, -5, 5, ANIM_TARGET, 0
	playsewithpan SE_M_BIND, SOUND_PAN_TARGET
	delay 10
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 6, 3, 0, 0, 75
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createvisualtask AnimTask_ScaleMonAndRestore, 5, 10, -5, 5, ANIM_TARGET, 0
	playsewithpan SE_M_BIND, SOUND_PAN_TARGET
	delay 10
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 28, 3, 0, 3, 70
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createvisualtask AnimTask_ScaleMonAndRestore, 5, 10, -5, 5, ANIM_TARGET, 0
	playsewithpan SE_M_BIND, SOUND_PAN_TARGET
	delay 10
	createsprite gFrenzyPlantRootSpriteTemplate, ANIM_ATTACKER, 2, 85, 20, 3, 0, 3, 70
	playsewithpan SE_M_SCRATCH, SOUND_PAN_TARGET
	delay 5
	createvisualtask AnimTask_ScaleMonAndRestore, 5, 10, -5, 5, ANIM_TARGET, 0
	playsewithpan SE_M_BIND, SOUND_PAN_TARGET
...
Move_DRAGON_FIST:
	loadspritegfx ANIM_TAG_SMALL_EMBER
	choosetwoturnanim DragonFistSetUp, DragonFistUnleash
DragonFistEnd:
	end
DragonFistSetUp:
	monbg ANIM_DEF_PARTNER
	setalpha 12, 11
	createvisualtask AnimTask_GetTargetIsAttackerPartner, 5, ARG_RET_ID
	jumpretfalse DragonFistSetUpAgainstOpponent
	goto DragonFistSetUpAgainstPartner
DragonFistSetUpAgainstOpponent:
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_BG | F_PAL_ATK_SIDE | F_PAL_DEF_PARTNER, 1, 0, 8, RGB_RED
	waitforvisualfinish
	delay 4
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 1, 8, 0, RGB_RED
	createvisualtask AnimTask_HorizontalShake, 5, ANIM_ATTACKER, 2, 16
	loopsewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_ATTACKER, 4, 8
	delay 4
	call DragonClawFireSpiral
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 1, 0, 15, RGB_YELLOW
	delay 20
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 1, 15, 0, RGB_YELLOW
	waitforvisualfinish
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_BG | F_PAL_ATK_PARTNER | F_PAL_DEF_PARTNER, 1, 8, 0, RGB_RED
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
	blendoff
	goto DragonFistEnd
DragonFistSetUpAgainstPartner:
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_BG | F_PAL_ATK_SIDE | F_PAL_DEF_PARTNER, 1, 0, 8, RGB_RED
	waitforvisualfinish
	delay 4
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 1, 8, 0, RGB_RED
...
DragonFistUnleash:
	...
	fadetobg BG_IMPACT_OPPONENT
	waitforvisualfinish
	createsprite gFistFootSpriteTemplate, ANIM_TARGET, 3, 0, 0, 100, 1, 0
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 2, -10, -8, ANIM_TARGET, 0
	playsewithpan SE_M_VITAL_THROW2, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMon, 5, ANIM_TARGET, 8, 0, 24, 1
	setarg 7, 0xFFFF
...
Move_SPIRIT_PURGE:
	...
	loadspritegfx ANIM_TAG_SMALL_EMBER
	createvisualtask AnimTask_CurseStretchingBlackBg, 5
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 0, 0, 16, RGB_BLACK
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 0, 0, 16, RGB_BLACK
	delay 6
	createsprite gHorizontalLungeSpriteTemplate, ANIM_ATTACKER, 2, 4, 4
	waitforvisualfinish
	...
	createsprite gRandomPosHitSplatSpriteTemplate, ANIM_TARGET, 3, ANIM_TARGET, 2
	createvisualtask SoundTask_PlaySE1WithPanning, 5, SE_M_COMET_PUNCH, SOUND_PAN_TARGET
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 0, 15, 0, RGB_BLACK
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 0, 15, 0, RGB_BLACK
	playsewithpan SE_M_TRI_ATTACK2, SOUND_PAN_TARGET
	createvisualtask AnimTask_HorizontalShake, 5, ANIM_TARGET, 5, 14
	call FireBlastCross
...
Move_CHISEL:
	...
	createsprite gHornHitSpriteTemplate, ANIM_TARGET, 4, 0, 0, 10
	waitforvisualfinish
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, 20, 24, 14, 2
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, 0, 5, 20, -24, 14, 2
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, 0, -5, 30, 18, 8, 2
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, -30, -18, 8, 2
	createsprite gFlashingHitSplatSpriteTemplate, ANIM_TARGET, 3, 0, 0, ANIM_TARGET, 1
	playsewithpan SE_M_HORN_ATTACK, SOUND_PAN_TARGET
	createvisualtask AnimTask_ShakeMon, 2, ANIM_TARGET, 5, 0, 6, 1
	waitforvisualfinish
	...
	createsprite gHornHitSpriteTemplate, ANIM_TARGET, 4, 0, 0, 10
	waitforvisualfinish
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, 5, 0, -20, 24, 14, 1
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, -5, 0, -20, -24, 14, 2
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, 30, -18, 8, 2
	createsprite gIceBallImpactShardSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, -30, 18, 8, 2
	createsprite gFlashingHitSplatSpriteTemplate, ANIM_TARGET, 3, 0, 0, ANIM_TARGET, 1
	playsewithpan SE_M_HORN_ATTACK, SOUND_PAN_TARGET
...
Move_VENOM_FANG:
	loadspritegfx ANIM_TAG_FANG_ATTACK
	loopsewithpan SE_M_TOXIC, SOUND_PAN_ATTACKER, 6, 6
	createvisualtask AnimTask_BlendColorCycle, 2, F_PAL_ATTACKER, 0, 4, 0, 12, RGB(26, 0, 26)
	createvisualtask AnimTask_WindUpLunge, 2, ANIM_ATTACKER, -24, 0, 24, 10, 24, 3
	delay 36
	playsewithpan SE_M_BITE, SOUND_PAN_TARGET
	createsprite gFangSpriteTemplate, ANIM_TARGET, 2
...
Move_GEYSER:
	...
	delay 68
	playsewithpan SE_M_EXPLOSION, SOUND_PAN_ATTACKER
	createsprite gDragonRageFirePlumeSpriteTemplate, ANIM_TARGET, 2, -32, 0, 36
	createsprite gDragonRageFirePlumeSpriteTemplate, ANIM_TARGET, 2, -20, -10, 24
	createsprite gDragonRageFirePlumeSpriteTemplate, ANIM_TARGET, 66, 32, 0, 12
	createsprite gDragonRageFirePlumeSpriteTemplate, ANIM_TARGET, 66, 20, 10, 24
	delay 7
	call RisingWaterHitEffect
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
...
gBattleAnimMove_BulletPunch::
	...
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 3, -8, 0, 8, 1, 0
	playsewithpan SE_M_COMET_PUNCH, SOUND_PAN_TARGET
	delay 1
	createsprite gFistFootSpriteTemplate, ANIM_ATTACKER, 3, 8, -16, 8, 1, 0
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 3, -16, 8, 8, 1, 0
	createsprite gFistFootSpriteTemplate, ANIM_ATTACKER, 3, 16, 16, 8, 1, 0
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 8, -16, 8, 1, 0
	playsewithpan SE_M_COMET_PUNCH, SOUND_PAN_TARGET
	delay 1
	createsprite gFistFootSpriteTemplate, ANIM_ATTACKER, 3, 0, 0, 8, 1, 0
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 16, 16, 8, 1, 0
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 0, 0, 8, 1, 0
	playsewithpan SE_M_COMET_PUNCH, SOUND_PAN_TARGET
	delay 1
...
Move_CLOSE_COMBAT:
	...
	playsewithpan SE_M_TAKE_DOWN, SOUND_PAN_ATTACKER
	delay 20
	createvisualtask AnimTask_BlendMonInAndOut, 3, ANIM_ATTACKER, RGB_WHITE, 10, 0, 2
	delay 20
	createvisualtask AnimTask_TraceMonBlended, 2, 0, 4, 7, 3
	waitforvisualfinish
	createsprite gFistFootRandomPosSpriteTemplate, ANIM_TARGET, 3, 1, 10, 0
...
General_TurnTrap:
	...
	jumpargeq 0, TRAP_ANIM_SPROUT, 	  Status_Sprout
