...
gBattleScriptsForMoveEffects::
	...
	.4byte BattleScript_EffectPanic                  @ EFFECT_PANIC
	...
	.4byte BattleScript_EffectLastStand       	     @ EFFECT_LAST_STAND
...
BattleScript_EffectAwakening::
	attackstring
	ppreduce
	jumpiftype BS_ATTACKER, TYPE_PSYCHIC, BattleScript_EffectSpecialAttackUp
	attackanimation
	waitanimation
	settypewithmove
	printstring STRINGID_PKMNCHANGEDTYPE
...
BattleScript_EffectVenomFang::
	attackcanceler
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
	jumpiftype BS_TARGET, TYPE_POISON, BattleScript_HitFromAtkString
	jumpifability BS_TARGET, ABILITY_IMMUNITY, BattleScript_HitFromAtkString
	attackstring
	ppreduce
	jumpifstatus2 BS_TARGET, STATUS2_CONFUSION, BattleScript_EffectVenomFangSleep
	attackanimation
	waitanimation
	critcalc
	damagecalc
...
BattleScript_EffectVenomFangSleep::
...
BattleScript_EffectGeyser::
	...
	critcalc
	damagecalc
	jumpiftype BS_TARGET, TYPE_FLYING, BattleScript_EffectGeyserBypass
	jumpifability BS_TARGET, ABILITY_LEVITATE, BattleScript_EffectGeyserBypass
	typecalc
	goto BattleScript_HitFromAtkAnimation
	
BattleScript_EffectGeyserBypass::
...
BattleScript_EffectPanic::
	attackcanceler
	attackstring
	ppreduce
	jumpifbattletype BATTLE_TYPE_ARENA, BattleScript_ButItFailed
	jumpifcantswitch SWITCH_IGNORE_ESCAPE_PREVENTION | BS_ATTACKER, BattleScript_ButItFailed
	jumpifstatus BS_ATTACKER, STATUS2_ESCAPE_PREVENTION | STATUS2_WRAPPED | STATUS2_CONFUSION | STATUS2_CURSED | STATUS2_INFATUATION, PanicDouble
PanicContinue:
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
	attackanimation
	waitanimation
...
BattleScript_EffectSweetScent::
	...
	ppreduce
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_StatDownEnd
	jumpifbyte CMP_LESS_THAN, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript_SweetScentDoAnim
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_FELL_EMPTY, BattleScript_SweetScentUp
	pause B_WAIT_TIME_SHORT
...
BattleScript_SweetScentDoAnim::
	...
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
BattleScript_SweetScentPrintString::
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_SweetScentUp::
	setstatchanger STAT_ACC, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_SweetScentEnd
	setgraphicalstatchangevalues
	playanimation BS_ATTACKER, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_SweetScentEnd::
	goto BattleScript_MoveEnd
...
BattleScript_EffectEntwine::
	...
	waitanimation
	effectivenesssound
	jumpifstatus2 BS_TARGET, STATUS2_ESCAPE_PREVENTION, BattleScript_EntwineContinue
	seteffectwithchance
	jumpifmove MOVE_VICE_GRIP, SkipEntwineParalyze
	setmoveeffect MOVE_EFFECT_PARALYSIS
	seteffectwithchance
SkipEntwineParalyze::
	hitanimation BS_TARGET
...
BattleScript_EffectLastStand::
	attackcanceler
	attackstring
	jumpifstatus2 BS_ATTACKER, STATUS2_FOCUS_ENERGY, BattleScript_ButItFailed
	jumpifcantswitch BS_ATTACKER, LastStandSuccess
	goto BattleScript_ButItFailed
LastStandSuccess::
	ppreduce
	setfocusenergy
BattleScript_LastStandDef::
	attackanimation
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_DEF | BIT_SPDEF, 0
	setstatchanger STAT_DEF, 2, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LastStandSpDef
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_LastStandSpDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_SHORT
BattleScript_LastStandSpDef::
	setstatchanger STAT_SPDEF, 2, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LastStandSpeed
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_LastStandSpeed
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_SHORT
BattleScript_LastStandSpeed::
	setstatchanger STAT_SPEED, 2, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_LastEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_LastEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_SHORT
BattleScript_LastEnd::
