...
const u32 gMonFrontPic_SceptileEX[] = INCBIN_U32("graphics/pokemon/sceptile/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_MawileEX[] = INCBIN_U32("graphics/pokemon/mawile/EXanim_front.4bpp.lz");
