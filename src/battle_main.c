...
const u8 gTypeEffectiveness[492] =
{
    TYPE_NORMAL, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NORMAL, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NORMAL, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FIRE, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_ELECTRIC, TYPE_SOUND, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_GRASS, TYPE_SOUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GRASS, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GRASS, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GRASS, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GRASS, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FIGHTING, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_POISON, TYPE_GRASS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_POISON, TYPE_BLADE, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_GROUND, TYPE_SOUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GROUND, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GROUND, TYPE_ASTRAL, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_FLYING, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_PSYCHIC, TYPE_BLADE, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_PSYCHIC, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_PSYCHIC, TYPE_ASTRAL, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_BUG, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_ROCK, TYPE_BLADE, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_DRAGON, TYPE_ASTRAL, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_DARK, TYPE_ASTRAL, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_STEEL, TYPE_BLADE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_FIRE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ASTRAL, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ASTRAL, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ASTRAL, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ASTRAL, TYPE_SOUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ASTRAL, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ASTRAL, TYPE_DRAGON, TYPE_MUL_NO_EFFECT,
    TYPE_BLADE, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BLADE, TYPE_GRASS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BLADE, TYPE_ELECTRIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BLADE, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BLADE, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BLADE, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BLADE, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BLADE, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BLADE, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BLADE, TYPE_STEEL, TYPE_MUL_NO_EFFECT,
    TYPE_BLADE, TYPE_BLADE, TYPE_MUL_NO_EFFECT,
    TYPE_SOUND, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SOUND, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SOUND, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SOUND, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SOUND, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SOUND, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SOUND, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SOUND, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SOUND, TYPE_ROCK, TYPE_MUL_NO_EFFECT,
    TYPE_SOUND, TYPE_ASTRAL, TYPE_MUL_NO_EFFECT,
...
const struct TrainerBall gTrainerBallTable[] = {
    ...
    {TRAINER_CLASS_CRYSTAL_DUKE, ITEM_PREMIER_BALL},
    {0xFF, ITEM_POKE_BALL},
};
...
static void Task_BeginBattleEvolutionScene(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        ...
        gBattleEnvironmentBackup = gBattleEnvironment; // Store the battle Environment to be reloaded later
...
u8 GetWhoStrikesFirst(u8 battler1, u8 battler2, bool8 ignoreChosenMoves)
{
    ...
    {
        speedBattler1 = (speedBattler1 * 115) / 100;
    }
    ...
    {
        speedBattler2 = (speedBattler2 * 115) / 100;
    }
