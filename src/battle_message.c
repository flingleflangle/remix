...
static const u8 sText_PkmnTrappedBySprout[] = _("{B_DEF_NAME_WITH_PREFIX} was trapped\nby SPROUT!");
...
static const u8 sText_PkmnWasPoisonedByToxicOrb[] = _("{B_ATK_NAME_WITH_PREFIX} was poisoned by\nits TOXIC ORB!");
...
static const u8 sText_PkmnWasBurnedByFlameOrb[] = _("{B_ATK_NAME_WITH_PREFIX} was burned by\nits FLAME ORB!");
...
static const u8 sText_PkmnStatusNormal[] = _("{B_EFF_NAME_WITH_PREFIX}'s status\nreturned to normal!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_TOXICORB - BATTLESTRINGS_TABLE_START] = sText_PkmnWasPoisonedByToxicOrb,
    ...
    [STRINGID_FLAMEORB - BATTLESTRINGS_TABLE_START] = sText_PkmnWasBurnedByFlameOrb,
    ...
    [STRINGID_PKMNTRAPPEDBYSPROUT - BATTLESTRINGS_TABLE_START] = sText_PkmnTrappedBySprout,
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    STRINGID_PKMNTRAPPEDBYSPROUT // MOVE_SPROUT
};
