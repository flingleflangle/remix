...
static const u16 sVerdanturfTentRewards[] = {ITEM_TM_SILVER_WIND};
...
static const u16 sFallarborTentRewards[] = {ITEM_TM_WEATHER_BALL};
...
static const u16 sSlateportTentRewards[] = {ITEM_TM_TRI_ATTACK};
