const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // Evolution Crystals
    [ITEM_STAR_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_NormalTMHM},
    [ITEM_AQUA_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_WaterTMHM},
    [ITEM_FIRE_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_FireTMHM},
    [ITEM_LAND_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_GrassTMHM},
    [ITEM_VOLT_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_ElectricTMHM},
    [ITEM_POWER_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_RockTMHM},
    [ITEM_MIND_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_PsychicTMHM},
    [ITEM_DARK_CRYSTAL] = {gItemIcon_Nugget, gItemIconPalette_DarkTMHM},
