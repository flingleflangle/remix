...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_SCEPTILE_EX] = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_MAWILE_EX]      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    ...
    [SPECIES_MUNCHLAX]    = { .size = MON_COORDS_SIZE(60, 48), .y_offset = 11 },
    [SPECIES_BONSLY]      = { .size = MON_COORDS_SIZE(36, 58), .y_offset =  7 },
    [SPECIES_GLISCOR]     = { .size = MON_COORDS_SIZE(64, 43), .y_offset = 11 },
    [SPECIES_WEAVILE]     = { .size = MON_COORDS_SIZE(64, 57), .y_offset =  5 },
