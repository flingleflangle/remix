...
static const u8 sGloryBlazeDescription[] = _(
    "Bursts into searing flames.\n"
    "More power with lower HP.");

static const u8 sIgniteDescription[] = _(
    "Heats up with a fiery aura.\n"
    "Trades HP for power.");

static const u8 sHotwireDescription[] = _(
    "Maximizes SP. ATK while\n"
    "sacrificing HP.");

static const u8 sSynchroBlastDescription[] = _(
...
static const u8 sTremorDescription[] = _(
    "Shakes the earth to flinch.\n"
