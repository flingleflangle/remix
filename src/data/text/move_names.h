const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_FINAL_STING] = _("FINAL STING"),
    [MOVE_FREEZE_RAY] = _("FREEZE RAY"),
    [MOVE_VILE_CUTTER] = _("VILE CUTTER"),
	[MOVE_FIRE_CRASH] = _("FIRE CRASH"),
	[MOVE_THUNDER_CRASH] = _("THUNDERCRASH"),
	[MOVE_STAGGER] = _("STAGGER"),
	[MOVE_TOMBSTONER] = _("TOMBSTONER"),
	[MOVE_SPROUT] = _("SPROUT"),
	[MOVE_SHRED] = _("SHRED"),
	[MOVE_ENTWINE] = _("ENTWINE"),
	[MOVE_DRAGON_FIST] = _("DRAGON FIST"),
	[MOVE_SOUL_STEAL] = _("SOUL STEAL"),
	[MOVE_ICE_SLASHER] = _("ICE SLASHER"),
	[MOVE_SPIRIT_PURGE] = _("SPIRIT PURGE"),
	[MOVE_U_TURN] = _("U-TURN"),
	[MOVE_CHISEL] = _("CHISEL"),
	[MOVE_ASCENSION] = _("ASCENSION"),
	[MOVE_AWAKENING] = _("AWAKENING"),
	[MOVE_ATTUNEMENT] = _("ATTUNEMENT"),
	[MOVE_VENOM_FANG] = _("VENOM FANG"),
	[MOVE_GEYSER] = _("GEYSER"),
	[MOVE_FLYING_KNEE] = _("FLYING KNEE"),
	[MOVE_BULLET_PUNCH] = _("BULLET PUNCH"),
	[MOVE_CLOSE_COMBAT] = _("CLOSE COMBAT"),
	[MOVE_DRAGON_LASH] = _("DRAGON LASH"),
	[MOVE_REVOLVER] = _("REVOLVER"),
	[MOVE_FLY_SWAT] = _("FLY SWAT"),
	[MOVE_AROUND_TOWN] = _("AROUND TOWN"),
	[MOVE_AURA_SPHERE] = _("AURA SPHERE"),
	[MOVE_SHIELD_BASH] = _("SHIELD BASH"),
	[MOVE_GRASS_KNOT] = _("GRASS KNOT"),
	[MOVE_BOULDER_DASH] = _("BOULDER DASH"),
	[MOVE_GLORY_BLAZE] = _("GLORY BLAZE"),
	[MOVE_IGNITE] = _("IGNITE"),
	[MOVE_HOTWIRE] = _("HOTWIRE"),
	[MOVE_SYNCHRO_BLAST] = _("SYNCHROBLAST"),
	[MOVE_BRAVE_BIRD] = _("BRAVE BIRD"),
	[MOVE_WAGER] = _("WAGER"),
	[MOVE_YOGA_LOOP] = _("YOGA LOOP"),
	[MOVE_SCALD] = _("SCALD"),
	[MOVE_NASTY_PLOT] = _("NASTY PLOT"),
	[MOVE_KALEIDOSCOPE] = _("KALEIDOSCOPE"),
	[MOVE_TREMOR] = _("TREMOR"),
	[MOVE_MIND_CRUSH] = _("MIND CRUSH"),
	[MOVE_SCISSOR_KICK] = _("SCISSOR KICK"),
	[MOVE_EXPLOIT] = _("EXPLOIT"),
	[MOVE_PANIC] = _("PANIC"),
	[MOVE_LAST_STAND] = _("LAST STAND"),
	[MOVE_FLUSH] = _("FLUSH"),
	[MOVE_OLD_FURY_CUTTER] = _("FURY CUTTER"),
	[MOVE_TRIPLE_SLASH] = _("TRIPLE SLASH"),
	[MOVE_WIDE_SLASH] = _("WIDE SLASH"),
	[MOVE_VACUUM_CUT] = _("VACUUM-CUT"),
	[MOVE_PIERCE] = _("PIERCE"),
	[MOVE_FOIL] = _("QUICK DRAW"),
	[MOVE_SERENADE] = _("SERENADE"),
	[MOVE_RESONATE] = _("RESONATE"),
