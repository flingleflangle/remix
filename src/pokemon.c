...
{                      // Attack  Defense  Speed  Sp.Atk  Sp.Def
    ...
    [NATURE_FIERCE] =  {   +2,     -5,     +1,     +2,     -5   },
    [NATURE_PATIENT] = {   -1,     +2,     -5,      0,     +2   },
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_HONCHKROW - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_MUNCHLAX - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BONSLY - 1]      = ANIM_H_SLIDE,
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (attacker->ability == ABILITY_HUGE_POWER || attacker->ability == ABILITY_PURE_POWER || attacker->ability == ABILITY_HUGE_POWER_EX)
        attack *= 2;
    ...
    defender->species == SPECIES_CATERPIE || defender->species == SPECIES_METAPOD || defender->species == SPECIES_WEEDLE || defender->species == SPECIES_KAKUNA || defender->species == SPECIES_PIDGEY || defender->species == SPECIES_PIDGEOTTO || defender->species == SPECIES_RATTATA ||
    defender->species == SPECIES_SPEAROW || defender->species == SPECIES_EKANS || defender->species == SPECIES_PIKACHU || defender->species == SPECIES_SANDSHREW ||
    defender->species == SPECIES_NIDORAN_F || defender->species == SPECIES_NIDORINA || defender->species == SPECIES_NIDORAN_M || defender->species == SPECIES_NIDORINO || defender->species == SPECIES_CLEFAIRY ||
    defender->species == SPECIES_VULPIX || defender->species == SPECIES_JIGGLYPUFF || defender->species == SPECIES_ZUBAT || defender->species == SPECIES_GOLBAT || defender->species == SPECIES_ODDISH || defender->species == SPECIES_GLOOM ||
    defender->species == SPECIES_PARAS || defender->species == SPECIES_VENONAT || defender->species == SPECIES_DIGLETT || defender->species == SPECIES_MEOWTH || defender->species == SPECIES_PSYDUCK ||
    defender->species == SPECIES_MANKEY || defender->species == SPECIES_GROWLITHE || defender->species == SPECIES_POLIWAG || defender->species == SPECIES_POLIWHIRL ||
    defender->species == SPECIES_ABRA || defender->species == SPECIES_KADABRA ||  defender->species == SPECIES_MACHOP || defender->species == SPECIES_MACHOKE || defender->species == SPECIES_BELLSPROUT || defender->species == SPECIES_WEEPINBELL ||
    defender->species == SPECIES_TENTACOOL || defender->species == SPECIES_GEODUDE || defender->species == SPECIES_GRAVELER || defender->species == SPECIES_PONYTA || defender->species == SPECIES_SLOWPOKE || defender->species == SPECIES_MAGNEMITE ||
    defender->species == SPECIES_DODUO || defender->species == SPECIES_SEEL || defender->species == SPECIES_GRIMER || defender->species == SPECIES_SHELLDER || defender->species == SPECIES_GASTLY || defender->species == SPECIES_HAUNTER || defender->species == SPECIES_ONIX ||
    defender->species == SPECIES_DROWZEE || defender->species == SPECIES_KRABBY || defender->species == SPECIES_VOLTORB || defender->species == SPECIES_EXEGGCUTE || defender->species == SPECIES_CUBONE || defender->species == SPECIES_KOFFING ||
    defender->species == SPECIES_RHYHORN || defender->species == SPECIES_CHANSEY || defender->species == SPECIES_TANGELA || defender->species == SPECIES_HORSEA || defender->species == SPECIES_SEADRA || defender->species == SPECIES_GOLDEEN || defender->species == SPECIES_STARYU ||
    defender->species == SPECIES_SCYTHER || defender->species == SPECIES_MAGIKARP || defender->species == SPECIES_EEVEE || defender->species == SPECIES_PORYGON || defender->species == SPECIES_OMANYTE || defender->species == SPECIES_KABUTO || defender->species == SPECIES_DRATINI || defender->species == SPECIES_DRAGONAIR ||
    defender->species == SPECIES_CHIKORITA || defender->species == SPECIES_BAYLEEF || defender->species == SPECIES_CYNDAQUIL || defender->species == SPECIES_QUILAVA || defender->species == SPECIES_TOTODILE || defender->species == SPECIES_CROCONAW ||
    defender->species == SPECIES_SENTRET || defender->species == SPECIES_HOOTHOOT || defender->species == SPECIES_LEDYBA || defender->species == SPECIES_SPINARAK || defender->species == SPECIES_CHINCHOU ||
    defender->species == SPECIES_PICHU || defender->species == SPECIES_CLEFFA || defender->species == SPECIES_IGGLYBUFF || defender->species == SPECIES_TOGEPI || defender->species == SPECIES_TOGETIC ||
    defender->species == SPECIES_NATU || defender->species == SPECIES_MAREEP || defender->species == SPECIES_FLAAFFY || defender->species == SPECIES_MARILL || defender->species == SPECIES_HOPPIP || defender->species == SPECIES_SKIPLOOM || defender->species == SPECIES_SUNKERN || defender->species == SPECIES_YANMA ||
    defender->species == SPECIES_WOOPER || defender->species == SPECIES_MURKROW || defender->species == SPECIES_MISDREAVUS || defender->species == SPECIES_PINECO || defender->species == SPECIES_GLIGAR || defender->species == SPECIES_SNUBBULL || defender->species == SPECIES_SNEASEL ||
    defender->species == SPECIES_TEDDIURSA || defender->species == SPECIES_SLUGMA || defender->species == SPECIES_SWINUB || defender->species == SPECIES_PILOSWINE || defender->species == SPECIES_REMORAID || defender->species == SPECIES_HOUNDOUR ||
    defender->species == SPECIES_PHANPY || defender->species == SPECIES_PORYGON2 || defender->species == SPECIES_TYROGUE || defender->species == SPECIES_SMOOCHUM ||
    defender->species == SPECIES_ELEKID || defender->species == SPECIES_MAGBY || defender->species == SPECIES_LARVITAR || defender->species == SPECIES_PUPITAR ||
    defender->species == SPECIES_TREECKO || defender->species == SPECIES_GROVYLE || defender->species == SPECIES_TORCHIC || defender->species == SPECIES_COMBUSKEN || defender->species == SPECIES_MUDKIP || defender->species == SPECIES_MARSHTOMP ||
    defender->species == SPECIES_POOCHYENA || defender->species == SPECIES_ZIGZAGOON || defender->species == SPECIES_WURMPLE || defender->species == SPECIES_SILCOON || defender->species == SPECIES_CASCOON ||
    defender->species == SPECIES_LOTAD || defender->species == SPECIES_LOMBRE || defender->species == SPECIES_SEEDOT || defender->species == SPECIES_NUZLEAF || defender->species == SPECIES_NINCADA || defender->species == SPECIES_TAILLOW || defender->species == SPECIES_SHROOMISH ||
    defender->species == SPECIES_WINGULL || defender->species == SPECIES_SURSKIT || defender->species == SPECIES_WAILMER || defender->species == SPECIES_SKITTY || defender->species == SPECIES_BALTOY ||
    defender->species == SPECIES_BARBOACH || defender->species == SPECIES_CORPHISH || defender->species == SPECIES_FEEBAS || defender->species == SPECIES_CARVANHA || defender->species == SPECIES_TRAPINCH || defender->species == SPECIES_VIBRAVA ||
    defender->species == SPECIES_MAKUHITA || defender->species == SPECIES_ELECTRIKE || defender->species == SPECIES_NUMEL || defender->species == SPECIES_SPHEAL || defender->species == SPECIES_SEALEO || defender->species == SPECIES_CACNEA ||
    defender->species == SPECIES_SNORUNT || defender->species == SPECIES_AZURILL || defender->species == SPECIES_SPOINK || defender->species == SPECIES_MEDITITE || defender->species == SPECIES_SWABLU || defender->species == SPECIES_WYNAUT ||
    defender->species == SPECIES_DUSKULL || defender->species == SPECIES_ROSELIA || defender->species == SPECIES_SLAKOTH || defender->species == SPECIES_VIGOROTH || defender->species == SPECIES_GULPIN || defender->species == SPECIES_WHISMUR || defender->species == SPECIES_LOUDRED ||
    defender->species == SPECIES_CLAMPERL || defender->species == SPECIES_SHUPPET || defender->species == SPECIES_ARON || defender->species == SPECIES_LAIRON || defender->species == SPECIES_LILEEP || defender->species == SPECIES_ANORITH ||
    defender->species == SPECIES_RALTS || defender->species == SPECIES_KIRLIA || defender->species == SPECIES_BAGON || defender->species == SPECIES_SHELGON || defender->species == SPECIES_BELDUM || defender->species == SPECIES_METANG ||
    ...
    //and it NEEDS to be there twice to do both defense stats. garbage.
    if (defenderHoldEffect == HOLD_EFFECT_EVIOLITE && 
    (defender->species == SPECIES_BULBASAUR || defender->species == SPECIES_IVYSAUR || defender->species == SPECIES_CHARMANDER || defender->species == SPECIES_CHARMELEON || defender->species == SPECIES_SQUIRTLE || defender->species == SPECIES_WARTORTLE ||
    defender->species == SPECIES_CATERPIE || defender->species == SPECIES_METAPOD || defender->species == SPECIES_WEEDLE || defender->species == SPECIES_KAKUNA || defender->species == SPECIES_PIDGEY || defender->species == SPECIES_PIDGEOTTO || defender->species == SPECIES_RATTATA ||
    defender->species == SPECIES_SPEAROW || defender->species == SPECIES_EKANS || defender->species == SPECIES_PIKACHU || defender->species == SPECIES_SANDSHREW ||
    ...
    for (i = 0; i < ITEM_EFFECT_ARG_START; i++)
    {
        ...
        case 3:
            ...
            if ((itemEffect[i] & ITEM3_POISON) && HealStatusConditions(mon, partyIndex, STATUS1_PSN_ANY | STATUS1_TOXIC_COUNTER, battler) == 0)
                retVal = FALSE;
            if ((itemEffect[i] & ITEM3_BURN) && HealStatusConditions(mon, partyIndex, STATUS1_BURN | STATUS1_IGNITE, battler) == 0)
                retVal = FALSE;
...
// above 248. The closest by default is Shuckle at 230.
    ...
    case 1:
        ...
        retVal /= 100;
        break;
    // adding a +2 modifies the stat even more
    case 2:
        retVal = stat * 120;
        retVal /= 100;
        break;
