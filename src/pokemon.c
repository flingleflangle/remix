...
static const u8 sHoldEffectToType[][2] =
{
    ...
    {HOLD_EFFECT_STAR_ENERGY, (TYPE_NORMAL || TYPE_FLYING || TYPE_DRAGON)},
    {HOLD_EFFECT_AQUA_ENERGY, (TYPE_WATER || TYPE_ICE)},
    {HOLD_EFFECT_LAND_ENERGY, (TYPE_BUG || TYPE_GRASS)},
    {HOLD_EFFECT_POWER_ENERGY, (TYPE_ROCK || TYPE_FIGHTING || TYPE_GROUND)},
    {HOLD_EFFECT_MIND_ENERGY, (TYPE_PSYCHIC || TYPE_GHOST)},
    {HOLD_EFFECT_SHADE_ENERGY, (TYPE_DARK || TYPE_POISON)},
};
