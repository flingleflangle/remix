...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_MAGNEMITE_EX] = gMonIcon_Magnemite,
    ...
    [SPECIES_LEDIAN_EX] = gMonIcon_Ledian,
    ...
    [SPECIES_SNEASEL_EX] = gMonIcon_Sneasel,
    ...
    [SPECIES_NOSEPASS_EX] = gMonIcon_Nosepass,
    [SPECIES_TORKOAL] = gMonIcon_Torkoal,
    [SPECIES_TORKOAL_EX] = gMonIcon_Torkoal,
    [SPECIES_SABLEYE] = gMonIcon_Sableye,
    [SPECIES_SABLEYE_EX] = gMonIcon_Sableye,
    ...
    [SPECIES_FLYGON_EX] = gMonIcon_Flygon,
    ...
    [SPECIES_GLALIE_EX] = gMonIcon_Glalie,
    ...
    [SPECIES_MAWILE_EX] = gMonIcon_Mawile,
    ...
    [SPECIES_AGGRON_EX] = gMonIcon_Aggron,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_BUTTERFREE_EX] = 0,
    [SPECIES_WEEDLE] = 1,
    [SPECIES_KAKUNA] = 2,
    [SPECIES_BEEDRILL] = 2,
    [SPECIES_BEEDRILL_EX] = 2,
    [SPECIES_PIDGEY] = 0,
    [SPECIES_PIDGEOTTO] = 0,
    [SPECIES_PIDGEOT] = 0,
    [SPECIES_RATTATA] = 2,
    ...
    [SPECIES_NIDORINA] = 2,
    [SPECIES_NIDOQUEEN] = 2,
    [SPECIES_NIDOQUEEN_EX] = 2,
    [SPECIES_NIDORAN_M] = 2,
    [SPECIES_NIDORINO] = 2,
    [SPECIES_NIDOKING] = 2,
    [SPECIES_NIDOKING_EX] = 2,
    [SPECIES_CLEFAIRY] = 0,
    [SPECIES_CLEFABLE] = 0,
    [SPECIES_VULPIX] = 2,
    [SPECIES_NINETALES] = 1,
    ...
    [SPECIES_CLAYDOL] = 0,
    [SPECIES_NOSEPASS] = 0,
    [SPECIES_NOSEPASS_EX] = 0,
    [SPECIES_TORKOAL] = 1,
    [SPECIES_TORKOAL_EX] = 1,
    [SPECIES_SABLEYE] = 2,
    [SPECIES_SABLEYE_EX] = 2,
    [SPECIES_BARBOACH] = 0,
    [SPECIES_WHISCASH] = 0,
    [SPECIES_LUVDISC] = 0,
    [SPECIES_CORPHISH] = 0,
