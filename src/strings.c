...
const u8 gText_PkmnLoweredToLvVar2[] = _("{STR_VAR_1}'s level was lowered \nto {STR_VAR_2}.");
...
const u8 gText_TM32AndPrice[] = _("TM32{CLEAR_TO 0x48}  500 COINS");
const u8 gText_TM29AndPrice[] = _("TM29{CLEAR_TO 0x48}1,500 COINS");
const u8 gText_TM35AndPrice[] = _("TM35{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_TM24AndPrice[] = _("TM24{CLEAR_TO 0x48}2,000 COINS");
const u8 gText_TM13AndPrice[] = _("TM13{CLEAR_TO 0x48}2,000 COINS");
...
const u8 gText_Pokenav_Access_PC[] = _("Remotely access your PC.");
const u8 gText_PutAwayPokenav[] = _("Put away the POKéNAV.");
const u8 gText_NoRibbonWinners[] = _("There are no RIBBON winners.");
const u8 gText_Pokenav_Cannot_Access_PC[] = _("-- NETWORK UNAVAILABLE --");
...
const u8 gText_MoveOkBack[] = _("{DPAD_NONE}MOVE  {A_BUTTON}OK  {B_BUTTON}BACK  {R_BUTTON}UPPER/LOWERCASE");
